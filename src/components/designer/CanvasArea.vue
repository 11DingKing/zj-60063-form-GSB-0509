    ...
    >
      <template v-if="!fields || fields.length === 0">
        <div class="canvas-area__empty">
          <svg class="canvas-area__empty-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
function handleFieldDrop() {
  if (dragFieldIndex.value !== null && dropFieldIndex.value !== null && dragFieldIndex.value !== dropFieldIndex.value) {
